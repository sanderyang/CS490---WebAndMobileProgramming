...
import com.sandy.firebase.SignUpActivity;
...
public class LoginActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(LoginActivity.this, com.sandy.firebase.HomeActivity.class);
    ...
    public void redirectToForgotPasswordPage(View v) {
        Intent redirect = new Intent(LoginActivity.this, com.sandy.firebase.ForgotPasswordActivity.class);
        startActivity(redirect);
    }
}