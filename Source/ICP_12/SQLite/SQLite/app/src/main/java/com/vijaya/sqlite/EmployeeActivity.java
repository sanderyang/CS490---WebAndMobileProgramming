...
public class EmployeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.DeleteEmployee.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                deleteFromDB();
            }
    ...
    public void deleteFromDB() {
        String theFirstName = binding.firstnameEditText.getText().toString();
        SQLiteDatabase db = new SampleDBSQLiteHelper(this).getReadableDatabase();
        db.delete(SampleDBContract.Employee.TABLE_NAME, SampleDBContract.Employee.COLUMN_FIRSTNAME + "='" +
                theFirstName + "'", null);
        Toast.makeText(this,theFirstName + " has been deleted from the database.",
                Toast.LENGTH_LONG).show();
    }

    public void updateItemFromDB(View view) {
    }
}