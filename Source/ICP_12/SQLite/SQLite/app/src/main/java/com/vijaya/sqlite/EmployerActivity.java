...
public class EmployerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.DeleteEmployer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                deleteFromDBEmployer();
            }
        });
    }
    ...
    public void deleteFromDBEmployer() {
        String companyName = binding.nameEditText.getText().toString();
        SQLiteDatabase database = new SampleDBSQLiteHelper(this).getReadableDatabase();
        database.delete(SampleDBContract.Employer.TABLE_NAME, SampleDBContract.Employer.COLUMN_NAME + "='" +
                companyName + "'", null);
        Toast.makeText(this,companyName + " has been deleted from the database.",
