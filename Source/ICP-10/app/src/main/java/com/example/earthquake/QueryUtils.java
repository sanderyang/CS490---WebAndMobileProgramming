...
public class QueryUtils {
    ...
    private static String getInputData (URL earthquakeURL) throws IOException {
        StringBuilder temp = new StringBuilder();
        BufferedReader in = new BufferedReader(new InputStreamReader(earthquakeURL.openStream()));
        String inputLine;
